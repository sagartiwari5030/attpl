...
export const PRODUCT_ROLE_OPTIONS = [
    { label: 'Booth Agent Leader', value: 'Booth Agent Leader' },
    { label: 'Ward Leader', value: 'Waed Leader' },
    { label: 'Slip Giver', value: 'Slip Giver' },
    { label: 'Transport Leader', value: 'Transport Leader' },
    { label: 'Food Leader', value: 'Food Leader' },
    { label: 'Voter Pick & Drop Leader', value: 'Voter Pick & Drop Leader' },
    { label: 'Hype Creater', value: 'Hype Creater' },
