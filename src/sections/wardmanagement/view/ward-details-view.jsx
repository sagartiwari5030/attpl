...
import { WardDetailsSkeleton } from '../ward-skeleton';
import WardDetailsReview from '../ward-details-review';
import WardDetailsSummary from '../ward-details-summary';
import WardDetailsToolbar from '../ward-details-toolbar';
import WardDetailsCarousel from '../ward-details-carousel';
import WardDetailsDescription from '../ward-details-description';
...
export default function WardDetailsView({ id }) {
  ...
  const renderSkeleton = <WardDetailsSkeleton />;
    ...
    <>
      ...
      <Card>
        ...
        {currentTab === 'description' && (
          <WardDetailsDescription description={product?.description} />
        )}
