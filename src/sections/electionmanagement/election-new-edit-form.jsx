...
export default function ElectionNewEditForm({ currentWard }) {
  // demo election type
  const electionType = [
    'Member of Parliament',
    'Member of Legislative Assembily',
    'Nagar Nigam PramukhZila',
    'Nagar Nigam ParshadZila',
    'ParishadPanchayat Samiti',
    'PradhanPanchayat Samiti',
    'MemberSarpanchWard Panch',
  ];
      ...
      {mdUp && (
        <Grid md={4}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            Election Title, description, type...
          </Typography>
        </Grid>
      )}
      ...
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            ...
            <RHFTextField name="description" label="Election Description" />
            ...
            <FormControl fullWidth>
              ...
              <Select name="electionType">
                <MenuItem value="option1">Member of Parliament</MenuItem>
                <MenuItem value="option2">Member of Legislative Assembly</MenuItem>
                <MenuItem value="option2">Nagar Nigam</MenuItem>
                <MenuItem value="option2">Nagar Nigam ParshadZila</MenuItem>
                <MenuItem value="option2">Nagar Nigam PramukhZila</MenuItem>
                <MenuItem value="option2">ParishadPanchayat Samiti</MenuItem>
                <MenuItem value="option2">PradhanPanchayat Samiti</MenuItem>
                <MenuItem value="option2">MemberSarpanchWard Panch</MenuItem>
              </Select>
            </FormControl>
            ...
            <FormControl fullWidth>
              ...
              <Select name="electionType">
                <MenuItem value="option1">In-Person</MenuItem>
                <MenuItem value="option2">In-Mail</MenuItem>
                <MenuItem value="option2">Online</MenuItem>
              </Select>
            </FormControl>
            ...
            <RHFTextField
              ...
              InputLabelProps={{ shrink: true }}
              label="Canditate Nomination Period"
              type="date"
            />
            <RHFTextField
    ...
    <>
      ...
      <Grid xs={12} md={8} sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <LoadingButton type="submit" variant="contained" size="large" loading={isSubmitting}>
          {!currentWard ? 'Create Election' : 'Save Changes'}
        </LoadingButton>
      </Grid>
    </>
  );
