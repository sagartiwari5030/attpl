...
export default function RoleListView() {
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.rolemanagement.edit(id));
      console.log('rolelist hello');
    },
    [router]
  );
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.dashboard.rolemanagement.details(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.rolemanagement.new}
              variant="contained"
