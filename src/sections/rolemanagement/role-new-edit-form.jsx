...
export default function RoleNewEditForm({ currentWard }) {
      ...
      {mdUp && (
        <Grid md={4}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            Role number, name, election date...
          </Typography>
        </Grid>
      )}
      ...
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            <RHFTextField name="rolename" label="First Name" type="number" />

            <RHFTextField name="rolename" label="Last Name" />
            ...
            <RHFTextField name="contactnumber" label="Contact Number" type="number" placeholder='0123456789' />

            <RHFTextField name="address" label="Address"  />

            <RHFTextField name="boothnumber" label="Booth Number" placeholder='######' />
            ...
            <RHFTextField name="wardnumber" label="Ward Number" type="number" placeholder='######' />
            
            <RHFMultiCheckbox row name="gender" spacing={2} options={PRODUCT_ROLE_OPTIONS} />
    ...
    <>
      ...
      <Grid xs={12} md={8} sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <LoadingButton type="submit" variant="contained" size="large" loading={isSubmitting}>
          {!currentWard ? 'Create Role' : 'Save Changes'}
        </LoadingButton>
      </Grid>
    </>
  );
