...
export default function ExpensesPDF({ expenses, currentStatus }) {
  const {
    items,
    taxes,
    dueDate,
      ...
      <Page size="A4" style={styles.page}>
        <View style={[styles.gridContainer, styles.mb40]}>
          ...
          <View style={{ alignItems: 'flex-end', flexDirection: 'column' }}>
            ...
            <Text> {expensesNumber} </Text>
          </View>
        </View>

        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            <Text style={[styles.subtitle2, styles.mb4]}>Expenses from</Text>
            <Text style={styles.body2}>{expensesFrom.name}</Text>
            <Text style={styles.body2}>{expensesFrom.fullAddress}</Text>
            <Text style={styles.body2}>{expensesFrom.phoneNumber}</Text>
          </View>

          <View style={styles.col6}>
            <Text style={[styles.subtitle2, styles.mb4]}>Expenses to</Text>
            <Text style={styles.body2}>{expensesTo.name}</Text>
            <Text style={styles.body2}>{expensesTo.fullAddress}</Text>
            <Text style={styles.body2}>{expensesTo.phoneNumber}</Text>
          </View>
        </View>
